...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        self.backgroundColor=[UIColor colorWithRed:(243/255.0) green:(23/255.0) blue:(52/255.0) alpha:1];
         ...
         _imagen=[[UIImageView alloc] initWithFrame:CGRectMake(10, 20, 50, 50)];
       ...
       // [self addSubview:circleView];
        ...
        _nombre=[[UILabel alloc]initWithFrame:CGRectMake(70, 5, 200, 70)];
        ...
        _hora=[[UILabel alloc]initWithFrame:CGRectMake(70, 60, 300, 34)];
       ...
       // _distancia=[[UILabel alloc]initWithFrame:CGRectMake(10, circleView.frame.size.height/2-10, 70, 21)];
          _distancia=[[UILabel alloc]initWithFrame:CGRectMake(270, 20, 70, 21)];
        _distancia.text=@"300 m";
        _distancia.textColor=[UIColor whiteColor];
        // [_distancia setFont:[UIFont systemFontOfSize:14]];
        [_distancia setFont:[UIFont fontWithName:@"NIISansLight" size:10]];
